...
";
    ...
    {
        return array (  129 => 25,  120 => 19,  115 => 16,  107 => 13,  104 => 12,  101 => 11,  95 => 9,  93 => 8,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"container\">
        <form method=\"post\">
            ...
            {% if app.user %}
                <div class=\"mb-3\">
                    Jesteś zalogowany jako {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
                </div>
            {% endif %}
